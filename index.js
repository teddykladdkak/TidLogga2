...
var param = {
	...
	url: 'https://www.tidlogga.teddyprojekt.se/',
...
app.engine('html', function (filePath, options, callback) {
  fs.readFile(filePath, function (err, content) {
    ...
    var rendered = content.toString()
    	...
    	.replace('#footer#', '</div><div id="footer">2018&nbsp;©&nbsp;Mattias Måsbäck&nbsp;¦&nbsp;{<a href="https://www.teddyprojekt.se/" alt="Länk till denna sida" onclick="internlink(this, event);">www.teddyprojekt.se</a>}</div></body></html>')
